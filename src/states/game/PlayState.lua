...
function PlayState:enter(params)
    ...
    self.level = LevelMaker.generate(width, 10, 'playstate')
...
function PlayState:render()
    ...
    if self.player.win then
        ...
        love.graphics.setColor(0, 0, 0, 255)
        love.graphics.printf('MATHEMATICAL!', 1, VIRTUAL_HEIGHT / 2 - 40 + 1, VIRTUAL_WIDTH, 'center')
        love.graphics.setColor(255, 255, 255, 255)
        love.graphics.printf('MATHEMATICAL!', 0, VIRTUAL_HEIGHT / 2 - 40, VIRTUAL_WIDTH, 'center')
    end
end
